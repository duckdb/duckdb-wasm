mergeInto(LibraryManager.library, {
    ...
    duckdb_web_udf_scalar_call: function (connId, funcId, bufferPtr, bufferSize) {
        return globalThis.DUCKDB_RUNTIME.callScalarUDF(Module, connId, funcId, bufferPtr, bufferSize);
    },
});
