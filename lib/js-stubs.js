mergeInto(LibraryManager.library, {
    duckdb_web_fs_read: function (fileId, buf, size, location) {
        return globalThis.DUCKDB_RUNTIME.duckdb_web_fs_read(fileId, buf, size, location);
    },
    duckdb_web_fs_write: function (fileId, buf, size, location) {
        return globalThis.DUCKDB_RUNTIME.duckdb_web_fs_write(fileId, buf, size, location);
    },
    ...
    duckdb_web_fs_file_open: function (path, pathLen, flags) {
        return globalThis.DUCKDB_RUNTIME.duckdb_web_fs_file_open(path, pathLen, flags);
    },
