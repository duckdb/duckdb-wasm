...
std::unique_ptr<duckdb::ArrowArrayStreamWrapper> TableReader::CreateStream(
    uintptr_t this_ptr, std::pair<std::unordered_map<idx_t, string>, std::vector<string>>& _project_columns,
