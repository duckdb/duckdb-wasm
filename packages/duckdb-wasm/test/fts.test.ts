...
export function testFTS(db: () => duckdb.DuckDBBindings): void {
    ...
    describe('FTS', () => {
        it('sample', async () => {
            ...
            await conn.query("INSERT INTO documents VALUES ('doc1', 'The mallard is a dabbling duck that breeds throughout the temperate.','Hannes Mühleisen', 3), ('doc2', 'The cat is a domestic species of small carnivorous mammal.', 'Laurens Kuiper', 2);");
            ...
            expect(result.getColumnAt(0)?.toArray()).toEqual(['doc1']);
        });
