...
const ALL_TYPES_TEST: AllTypesTest[] = [
    {
        ...
        query: `SELECT * EXCLUDE(bignum, uhugeint, fixed_int_array, fixed_varchar_array, fixed_nested_int_array, fixed_nested_varchar_array, fixed_struct_array, struct_of_fixed_array, fixed_array_of_int_list, list_of_fixed_int_array) REPLACE('not_implemented' as map) FROM test_all_types()`,
