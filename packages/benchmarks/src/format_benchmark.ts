import * as duckdb from '../../duckdb-wasm/dist/duckdb-node-sync-eh.js';
...
const db = new duckdb.DuckDB(logger, duckdb.NODE_RUNTIME, path.join(__dirname, '../../duckdb/dist/duckdb.wasm'));
db.open()
    .then(() => main(db))
